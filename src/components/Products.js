...
class Products extends React.Component {
    ...
    purchaseProductClicked = async (price, index) => {
        ...
        const tx = await contract.methods.purchaseProduct(selectedStorefront.addr, selectedStorefront.index, index, PURCHASE_QUANTITY).send({
            value: price,
            from: accounts[0]
        });
                                ...
                                <GridListTileBar
                                    ...
                                    actionIcon={
                                        <IconButton color="primary" className={classes.button}
                                                    ...
                                                    onClick={() => this.purchaseProductClicked(product.price, product.index)}
