                                            ...
                                            <Grid item xs container direction="column" spacing={16}>
                                                ...
                                                <Grid item>
                                                    <Button variant="contained" className={classes.button}
                                                            disabled={storefront.productCount === 0}
                                                            onClick={() => this.checkProductsClicked(storefront.name, storefront.owner, storefront.index)}>
                                                        Check products
                                                    </Button>
                                                </Grid>
                                            </Grid>
...
const mapDispatchToProps = (dispatch) => {
    return {
        storefrontSelected(product) {
            dispatch(Actions.storefrontSelected(product))
        },
        pageSelected(page) {
