...
import {IpfsUtil} from '../helpers/ipfs';
        ...
        return (
            <div>
                <Paper className={classes.addProductPaper}>
                    ...
                    <br/>
                    <Button variant="contained" color="primary" disabled={maxProductCountReached}
                            className={classes.button} onClick={() => this.addProductClicked()}>
                        Add product
                    </Button>
                </Paper>
                <br/>
                                                ...
                                                <Grid item xs container direction="column" spacing={16}>
                                                    ...
                                                    <Grid item>
                                                        <Button variant="contained" color="primary"
                                                                ...
                                                                onClick={() => this.updateProductPriceClicked(product.index)}>
                                                            Update price
                                                        </Button>
                                                        <Button variant="contained" color="secondary"
                                                                className={classes.button}
                                                                disabled={product.quantity === 0}
                                                                onClick={() => this.removeProductClicked(product.index)}>
                                                            Remove product
                                                        </Button>
                                                    </Grid>
                                                </Grid>
