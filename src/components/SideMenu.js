...
class SideMenu extends React.Component {
    ...
    manageVitrinaClicked = (side, open) => {
        this.context.router.history.push("/managevitrina");
        this.props.pageSelected("managevitrina");
    };
    ...
    render() {
        ...
        const sideList = (
            <div className={classes.list}>
                ...
                <Divider/>
                <List>
                    <ListItem button key='ManageVitrina' onClick={this.manageVitrinaClicked}>
...
const mapDispatchToProps = (dispatch) => {
    return {
        drawerStateUpdated(drawerState) {
            dispatch(Actions.drawerStateUpdated(drawerState))
        },
        pageSelected(page) {
